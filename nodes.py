...
def sameTrees(t1,t2):
    if t1 and t2:
        if t1.symbol != t2.symbol:
            return False
        return (sameTrees(t1.left,t2.left) and sameTrees(t1.right,t2.right))
    return True
...
if __name__ == '__main__':
    ...
    sameTrees(HuffmanNode(4,HuffmanNode(3),HuffmanNode(2)), HuffmanNode(4,HuffmanNode(3),HuffmanNode(1)))
